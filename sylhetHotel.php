...
<body>
		...
		<form name="myForm" onsubmit="return validate()" action="sylhetUpdate.php" method="Post">
		...
		<div class="flowDescription" style="color: black;text-align: left">
			...
			<div class="flowDescription">
				...
				<select id="hotelSelectCmb" name="HotelCmb" >
					...
					<option value="Hotel Star Pacific">Hotel Star Pacific</option>
					<option value="The Boutique Hotel">The Boutique Hotel</option>
					<option value="Hotel Noorjahan Grand">Hotel Noorjahan Grand</option>
					<option value="Hotel Garden Inn">Hotel Garden Inn</option>
				</select>
				<br>
				Select Rooms:
		...
		<script type="text/javascript" src="js/hotelRateSyl.js"></script>
