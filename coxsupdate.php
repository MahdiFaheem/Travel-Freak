...
if (isset($_POST['checkBillBtn'])) {
    ...
    $sqlhtlsg = "SELECT sPrice,htlId FROM hotelcox WHERE htlName='$htl'";
    ...
    $sqlhtldb = "SELECT dPrice,htlId FROM hotelcox WHERE htlName='$htl'";
	...
	$_SESSION['brkfoodid'] = $breakFoodID;
	$_SESSION['lunfoodid'] = $lunchFoodID;
	$_SESSION['dinfoodid']= $dinnerFoodID;
